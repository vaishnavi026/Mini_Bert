...
class BertSentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        # todo
        self.out_layer = nn.Linear(config.hidden_size, self.num_labels)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        projected_output = self.out_layer(self.out_dropout(pooled_output))
        return F.log_softmax(projected_output, dim=-1)
